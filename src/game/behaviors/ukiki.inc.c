...
void idle_ukiki_taunt(void) {
    ...
    switch (o->oSubAction) {
        case UKIKI_SUB_ACT_TAUNT_ITCH:
            cur_obj_init_animation(UKIKI_ANIM_ITCH);
        ...
        case UKIKI_SUB_ACT_TAUNT_SCREECH:
            cur_obj_init_animation(UKIKI_ANIM_SCREECH);
        ...
        case UKIKI_SUB_ACT_TAUNT_JUMP_CLAP:
            cur_obj_init_animation(UKIKI_ANIM_JUMP_CLAP);
        ...
        case UKIKI_SUB_ACT_TAUNT_HANDSTAND:
            cur_obj_init_animation(UKIKI_ANIM_HANDSTAND);
...
void ukiki_act_return_home(void) {
    ...
    cur_obj_init_animation(UKIKI_ANIM_RUN);
...
void ukiki_act_turn_to_mario(void) {
    ...
    cur_obj_init_animation(UKIKI_ANIM_TURN);
...
void ukiki_act_jump(void) {
    ...
    if (o->oSubAction == 0) {
        ...
        o->oForwardVel = 0.0f;
        cur_obj_init_animation(UKIKI_ANIM_LAND);
